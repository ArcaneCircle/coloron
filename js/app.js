...
class Game {
  ...
  intro() {
    ...
    let one = $(
      ".how-to-play .section-2 .content .stick.inactive:nth-child(1)",
    );
    let two = $(
      ".how-to-play .section-2 .content .stick.inactive:nth-child(2)",
    );
    let three = $(
      ".how-to-play .section-2 .content .stick.inactive:nth-child(3)",
    );
